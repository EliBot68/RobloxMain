...
# Remove safe files
$removedCount = 0
Write-Host "`nRemoving safe files..." -ForegroundColor Green
...
if ($keepFiles.Count -gt 0) {
    Write-Host "`n📋 Remaining empty files (review manually):" -ForegroundColor Yellow
...
Write-Host "`n🚀 Option A cleanup complete! Your project is now cleaner." -ForegroundColor Green
